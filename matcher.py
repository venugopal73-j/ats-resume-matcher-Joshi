...
def analyze_keywords(resume_text, job_desc_text):
    ...
    # Extract unique keywords from cleaned JD and resume
    ...
    # Sort alphabetically
    return {
        "missing_keywords": sorted(missing_keywords, key=lambda x: x),
        "matched_keywords": sorted(matched_keywords, key=lambda x: x)
    }